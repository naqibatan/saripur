AmCharts.AmSerialChart = AmCharts.Class({
  ...
  getClosestIndex: function (a, b, c, d, e, g) {
    ...
    return c == n
      ? k
      : c < n
      ? this.getClosestIndex(a, b, c, d, e, k)
      : this.getClosestIndex(a, b, c, d, k, g);
  },
    ...
    if (b) {
      ...
      for (var n = 0; n < c.length; n++) {
        ...
        a = AmCharts.formatValue(
          a,
          { open: m, close: u, high: s, low: p, average: y, sum: h, count: f },
          d,
          k,
          l + "\\.",
          this.usePrefixes,
  ...
  formatString: function (a, b, c) {
    ...
    if (-1 != a.indexOf("[[category]]")) {
      ...
      if (this.categoryAxis.parseDates) {
        var g = this.balloonDateFormat,
          k = this.chartCursor;
        k && (g = k.categoryBalloonDateFormat);
        -1 != a.indexOf("[[category]]") &&
          ((g = AmCharts.formatDate(e, g)),
          -1 != g.indexOf("fff") && (g = AmCharts.formatMilliseconds(g, e)),
          (e = g));
      }
    ...
    a = AmCharts.formatValue(a, b.values, ["percents"], g);
    -1 != a.indexOf("[[") &&
...
AmCharts.Cuboid = AmCharts.Class({
  construct: function (a, b, c, d, e, g, k, n, l, h, f, m, u, p, s) {
    this.set = a.set();
    this.container = a;
    this.h = Math.round(c);
    this.w = Math.round(b);
  ...
  draw: function () {
    ...
    if (0 < e || 0 < g)
      (A = w),
        (w = AmCharts.adjustLuminosity(y, -0.2)),
        (w = AmCharts.adjustLuminosity(y, -0.2)),
        (r = AmCharts.polygon(
          b,
          [0, e, c + e, c, 0],
        ...
        0 < f && (C = AmCharts.line(b, [0, e, c + e], [0, g, g], h, f, l, p)),
        (q = AmCharts.polygon(
          b,
          [0, 0, c, c, 0],
          [0, d, d, 0, 0],
        ...
        q.translate(e, g),
        0 < f && (t = AmCharts.line(b, [e, e], [g, g + d], h, f, l, p)),
        (v = AmCharts.polygon(
          b,
          [0, 0, e, e, 0],
          [0, d, d + g, g, 0],
        ...
        (w = AmCharts.adjustLuminosity(A, 0.2)),
        (A = AmCharts.polygon(
          b,
          [0, e, c + e, c, 0],
          [d, d + g, d + g, d, d],
        ...
        0 < f &&
          (x = AmCharts.line(b, [0, e, c + e], [d, d + g, d + g], h, f, l, p));
    n = D;
    1 > Math.abs(d) && (d = 0);
    1 > Math.abs(c) && (c = 0);
    b =
      0 === d
        ? AmCharts.line(b, [0, c], [0, 0], h, f, l, p)
        : 0 === c
        ? AmCharts.line(b, [0, 0], [0, d], h, f, l, p)
        : 0 < u
        ? AmCharts.rect(b, c, d, k, n, l, h, f, u, m, p)
        : AmCharts.polygon(
            b,
            [0, 0, c, c, 0],
            [0, d, d, 0, 0],
...
AmCharts.CategoryAxis = AmCharts.Class({
    ...
    if (AmCharts.ifArray(a)) {
      ...
      var r = this.firstDayOfWeek,
        ...
        a = AmCharts.resetDateToMin(
          new Date(a[a.length - 1].time + 1.05 * h),
          this.minPeriod,
          1,
          r
        ).getTime(),
      ...
      if (this.parseDates && !this.equalSpacing) {
        ...
        p < h && ((e = m.period), (u = m.count), (p = h));
        s = e;
        "WW" == s && (s = "DD");
        this.stepWidth = this.getStepWidth(this.timeDifference);
        var k = Math.ceil(this.timeDifference / p) + 5,
          B = (f = AmCharts.resetDateToMin(
            new Date(this.startTime - p),
            e,
            u,
            r
          ).getTime());
        ...
        t &&
          1 < u &&
          ((v = this.chooseMinorFrequency(u)),
          (z = AmCharts.getPeriodDuration(e, v)));
        if (0 < this.gridCountR)
          for (b = d; b <= k; b++) {
            m = A + p * (b + Math.floor((B - A) / p)) - x;
            "DD" == e && (m += 36e5);
            m = AmCharts.resetDateToMin(new Date(m), e, u, r).getTime();
            "MM" == e &&
              ((t = (m - f) / p),
              1.5 <= (m - f) / p &&
                ((m = m - (t - 1) * p + AmCharts.getPeriodDuration("DD", 3)),
                (m = AmCharts.resetDateToMin(new Date(m), e, 1).getTime()),
                (x += p)));
            h = (m - this.startTime) * this.stepWidth;
            w = !1;
            this.nextPeriod[s] &&
              (w = this.checkPeriodChange(this.nextPeriod[s], 1, m, f, s));
            t = !1;
            w && this.markPeriodChange
              ? ((f = this.dateFormatsObject[this.nextPeriod[s]]), (t = !0))
              : (f = this.dateFormatsObject[s]);
            q || (t = !1);
            f = AmCharts.formatDate(new Date(m), f);
            if ((b == d && !n) || (b == k && !l)) f = " ";
            this.labelFunction &&
              (f = this.labelFunction(f, new Date(m), this).toString());
            ...
            if (!isNaN(v))
              for (h = 1; h < u; h += v)
                (this.gridAlpha = this.minorGridAlpha),
                  (t = m + z * h),
                  (t = AmCharts.resetDateToMin(new Date(t), e, v, r).getTime()),
        ...
        if (
          ...
          for (
            ...
            0 <= b && b < this.data.length
              ? ((s = this.data[b]), (f = s.category), (r = s.forceShow))
              : (f = "");
            if (t && !isNaN(v))
              if (b / v == Math.round(b / v) || r)
                b / q == Math.round(b / q) ||
                  r ||
                  ((this.gridAlpha = this.minorGridAlpha), (f = void 0));
              else continue;
            else if (b / q != Math.round(b / q) && !r) continue;
            h = this.getCoordinate(b - g);
            r = 0;
            "start" == this.gridPosition &&
              ((h -= this.cellWidth / 2), (r = this.cellWidth / 2));
            if ((b == d && !n) || (b == this.end && !l)) f = void 0;
            Math.round(k / e) != k / e && (f = void 0);
            k++;
            B = this.cellWidth;
            u && (B = NaN);
            this.labelFunction && s && (f = this.labelFunction(f, s, this));
            f = AmCharts.fixBrakes(f);
        ...
        if (
          ...
          for (r = 0, A = f, b = h; b < y; b++)
            (m = this.data[b].time),
              this.checkPeriodChange(e, u, m, A) &&
                (r++, 2 <= r && ((p = b), (b = y)), (A = m));
        t &&
          1 < u &&
          ((v = this.chooseMinorFrequency(u)),
          AmCharts.getPeriodDuration(e, v));
        for (b = h; b < y; b++)
          if (
            ((m = this.data[b].time),
            this.checkPeriodChange(e, u, m, f) && b >= p)
          ) {
            ...
            z
              ...
              : (q || (t = !1),
                h - this.previousPos >
                  ...
                  (this.labelFunction &&
                    (f = this.labelFunction(f, new Date(m), this)),
                  ...
                  this.pushAxisItem(f),
                  (r = r.getBBox().width),
                  AmCharts.isModern || (r -= h),
                  (this.previousPos = h + r)));
            f = m;
          } else
            isNaN(v) ||
              (this.checkPeriodChange(e, v, m, B) &&
                ((this.gridAlpha = this.minorGridAlpha),
                (h = this.getCoordinate(b - this.start)),
                (t = new this.axisItemRenderer(this, h)),
                this.pushAxisItem(t),
                (B = m)),
              (this.gridAlpha = a));
      }
      ...
      for (b = 0; b < n; b++)
        (l = this.guides[b]),
          ...
          l.toCategory &&
            ...
            isNaN(q) ||
              ((d = this.getCoordinate(q - g)),
              (f = new this.axisItemRenderer(this, d, "", !0, NaN, NaN, l)),
              this.pushAxisItem(f, v))),
          l.category &&
            ((q = c.getCategoryIndexByValue(l.category)),
            isNaN(q) ||
              ((a = this.getCoordinate(q - g)),
              (q = (d - a) / 2),
              (f = new this.axisItemRenderer(this, a, l.label, !0, NaN, q, l)),
              this.pushAxisItem(f, v))),
          l.toDate &&
            (this.equalSpacing
              ? ((q = c.getClosestIndex(
                ...
                isNaN(q) || (d = this.getCoordinate(q - g)))
          ...
          l.date &&
            (this.equalSpacing
              ? ((q = c.getClosestIndex(
                ...
                isNaN(q) || (a = this.getCoordinate(q - g)))
              : (a = (l.date.getTime() - this.startTime) * this.stepWidth),
            (q = (d - a) / 2),
            (f =
              "H" == this.orientation
                ? new this.axisItemRenderer(this, a, l.label, !1, 2 * q, NaN, l)
                : new this.axisItemRenderer(this, a, l.label, !1, NaN, q, l)),
            this.pushAxisItem(f, v)),
          (d = new this.guideFillRenderer(this, a, d, l)),
          (a = d.graphics()),
          this.pushAxisItem(d, v),
          (l.graphics = a),
          (a.index = b),
          l.balloonText && this.addEventListeners(a, l);
    }
    this.axisCreated = !0;
    c = this.x;
    g = this.y;
  ...
  checkPeriodChange: function (a, b, c, d, e) {
    ...
    b = AmCharts.resetDateToMin(g, a, b, k).getTime();
