...
-1 != AmCharts.navigator.indexOf("msie") &&
  ((AmCharts.IEversion = parseInt(AmCharts.navigator.split("msie")[1])),
  document.documentMode && (AmCharts.IEversion = Number(document.documentMode)),
  9 > AmCharts.IEversion && (AmCharts.isModern = !1));
AmCharts.dx = 0;
AmCharts.dy = 0;
...
AmCharts.wrappedText = function (a, b, c, d, e, f, g, h, k) {
  ...
  if (l) {
    ...
    if (n.width > h) {
      ...
      for (
        var r = Math.round(b.length / 2), u = 1e3, q, p = 0;
        p < l.length;
        p++
      ) {
  ...
  draw: function () {
    ...
    if (
      ...
      if (
        ...
        1 > this.step &&
          -1 < this.step &&
          (q = AmCharts.getDecimals(this.step));
        ...
        if (0 < A) {
          ...
          for (d = this.fillAlpha = 0; d < A; d++) {
            var C = w[d],
              ...
              z = C.above;
            isNaN(C.toValue) ||
              ((y = this.getCoordinate(C.toValue)),
              (s = new this.axisItemRenderer(this, y, "", !0, NaN, NaN, C)),
              this.pushAxisItem(s, z));
            var J = NaN;
            isNaN(C.value) ||
              ((J = this.getCoordinate(C.value)),
              (s = new this.axisItemRenderer(
                this,
                J,
                C.label,
                !0,
              ...
              this.pushAxisItem(s, z));
            isNaN(y - J) ||
              ((s = new this.guideFillRenderer(this, J, y, C)),
              this.pushAxisItem(s, z),
              (s = s.graphics()),
              (C.graphics = s),
              C.balloonText && this.addEventListeners(s, C));
          }
          this.fillAlpha = c;
        }
        w = !1;
        for (d = p; d < r; d += n)
          (A = AmCharts.roundTo(this.step * d + this.min, q)),
        ...
        this.minorGridEnabled &&
          (I = this.getMinorGridStep(q, this.stepWidth * q));
        for (d = p; d < r; d += n)
          if (
            ((p = q * d + this.min),
            ...
            if (isNaN(t) || Number(AmCharts.toFixed(p, t)) == p) {
              ...
              w
                ...
                : (h &&
                  ...
                  (s = this.usePrefixes
                    ...
                    : AmCharts.formatNumber(p, v, v.precision)));
              this.duration &&
                (s = AmCharts.formatDuration(
                  p,
                  this.duration,
                  "",
                  this.durationUnits,
              ...
              this.recalculateToPercents
                ? (s += "%")
                : (c = this.unit) &&
                  (s = "left" == this.unitPosition ? c + s : s + c);
              Math.round(d / k) != d / k && (s = void 0);
              if ((0 === d && !l) || (d == r - 1 && !m)) s = " ";
              c = this.getCoordinate(p);
              this.labelFunction &&
                (s = this.labelFunction(p, s, this).toString());
              ...
              if (!isNaN(I) && 0 < A && d < r - 1) {
                ...
                for (c = 1; c < q / I; c++)
                  (C = this.getCoordinate(p + I * c)),
                    (C = new this.axisItemRenderer(
                      this,
                      C,
                      "",
                      !1,
    ...
    for (k = this.start; k <= this.end; k++) {
      ...
      for (n = 0; n < h.length; n++)
        if (
          ...
          r &&
            m &&
            (m = this.data[k].axes[this.id].graphs[m.id]) &&
    ...
    for (b = 0; b < a.length; b++) {
      ...
      if (c.valueAxis == this) {
        ...
        for (
          k = f;
          k <= g &&
          ((f = this.data[k].axes[this.id].graphs[c.id]),
          (e = f.values[d]),
          isNaN(e));
          k++
        );
...
AmCharts.RecItem = AmCharts.Class({
  construct: function (a, b, c, d, e, f, g, h, k, l) {
    ...
    g
      ? ((I = !0),
        isNaN(g.tickLength) || (s = g.tickLength),
        void 0 != g.lineColor && (C = g.lineColor),
        void 0 != g.color && (p = g.color),
        isNaN(g.lineAlpha) || (w = g.lineAlpha),
        isNaN(g.dashLength) || (y = g.dashLength),
        isNaN(g.lineThickness) || (A = g.lineThickness),
        !0 === g.inside && (S = !0),
        isNaN(g.labelRotation) || (B = g.labelRotation),
        isNaN(g.fontSize) || (n = g.fontSize),
    ...
    I &&
      ((x =
        a.autoWrap && 0 === B
          ? AmCharts.wrappedText(r, c, p, m, n, W, h, e, 0)
          : AmCharts.text(r, c, p, m, n, W, h)),
      (P = x.getBBox().width));
    if ("H" == Fa) {
      if (
        (0 <= b &&
          ...
          (0 < s &&
            0 < v &&
            b + k <= V + 1 &&
            ((Y = AmCharts.line(r, [b + k, b + k], [0, s], t, v, A)),
            u.push(Y)),
          0 < w &&
            ((W = AmCharts.line(
              r,
        ...
        !1 === d
          ? ((W = "start"),
            (D = "bottom" == ea ? (S ? D + s : D - s) : S ? D - s : D + s),
            (G += 3),
            e && ((G += e / 2), (W = "middle")),
            0 < B && (W = "middle"))
          : (W = "middle"),
        1 == Z &&
          ...
          ($ = AmCharts.fitToBounds($, 0, V)),
          (ha = d - $),
          0 < ha &&
            ((fill = AmCharts.rect(r, ha, a.height, z, J)),
            fill.translate(d - ha + da, X),
            u.push(fill))),
        "bottom" == ea
          ? ((D += L + n / 2 + oa),
            S
              ? 0 < B
                ? ((D = L - (P / 2) * Math.sin(aa) - s - 3),
                  (G += (P / 2) * Math.cos(aa)))
                : 0 > B
                ? ((D -= s + n + 3 + 3 - (P / 2) * Math.sin(aa)),
                  (G -= (P / 2) * Math.cos(aa)))
                : (D -= s + n + 3 + 3)
              : 0 < B
              ? ((D = L + (P / 2) * Math.sin(aa) + s + 3),
          ...
          : ((D += X + n / 2 - oa),
            ...
            S
              ? 0 < B
                ? ((D = (P / 2) * Math.sin(aa) + s + 3),
                  (G -= (P / 2) * Math.cos(aa)))
                : (D += s + 3)
              : 0 < B
              ? ((D = -(P / 2) * Math.sin(aa) - s - 6),
                (G += (P / 2) * Math.cos(aa)))
              : (D -= s + n + 3 + q + 3)),
        "bottom" == ea
          ? (ha = (S ? L - s - 1 : L + q - 1) + oa)
          : ((ia = da), (ha = (S ? X : X - s - q + 1) - oa)),
        f && (G += f),
        (X = G),
        0 < B && (X += (P / 2) * Math.cos(aa)),
        x &&
          ((ea = 0),
          S && (ea = (P / 2) * Math.cos(aa)),
          X + ea > V + 2 || 0 > X))
      )
        x.remove(), (x = null);
    } else {
      0 <= b &&
        ...
        (0 < s &&
          0 < v &&
          b + k <= L + 1 &&
          ((Y = AmCharts.line(r, [0, s], [b + k, b + k], t, v, A)), u.push(Y)),
        0 < w &&
          ((W = AmCharts.line(
            r,
            [0, da, V + da],
      ...
      1 == Z &&
        ...
        !g &&
        !l &&
        ((d = AmCharts.fitToBounds(b, 0, L)),
        ($ = AmCharts.fitToBounds($, 0, L)),
        (aa = d - $),
      ...
      "right" == ea
        ? ((G += da + V + oa),
          ...
          S
            ...
            : ((G += s + 4 + q), (D -= 2)))
        : S
        ? ((G += s + 4 - oa), f || (D -= n / 2 + 3), g && ((G += da), (D += X)))
        : ((G += -s - q - 4 - 2 - oa), (D -= 2));
      Y &&
        ("right" == ea
          ? ((ia += da + oa + V), (ha += X), (ia = S ? ia - q : ia + q))
          : ((ia -= oa), S || (ia -= s + q)));
      f && (D += f);
      S = -3;
      "right" == ea && (S += X);
    ...
    x &&
      (x.attr({ "text-anchor": W }),
      x.translate(G, D),
      0 !== B && x.rotate(-B, a.chart.backgroundColor),
      a.allLabels.push(x),
      " " != c && (this.label = x));
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    if (
      ...
      n
        ? ((ab = l),
          ...
          (eb = Math.abs(Za - xa)),
          (Ya = cb = 0),
          f.reversed ? ((Wa = 0), (Xa = xa)) : ((Wa = xa), (Xa = 0)))
        : ((bb = k),
          (ab = Math.abs(ub - xa)),
          (eb = k),
          (db = Math.abs(Za - xa)),
          (Xa = Wa = 0),
          f.reversed ? ((Ya = m), (cb = xa)) : (Ya = xa + 1));
    }
    var ya = Math.round;
    this.pmx = ya(Wa);
    this.pmy = ya(cb);
    ...
    if ("line" == g || "step" == g || "smoothedLine" == g) {
      if (0 < Z) {
        ...
        if (this.dashLengthField)
          for (H = Z; -1 < H; H--)
            if (
              ((P = d[H]), (x = P.axes[f.id].graphs[b]), !isNaN(x.dashLength))
            ) {
    ...
    for (H = Z; H <= S; H++) {
      ...
      if (ta) {
        ...
        "start" == this.pointPosition &&
          ((ja -= D / 2 + Math.floor((Ha * D) / 2)),
          (ka = 0),
          (ua = Math.floor(D) + Math.floor(Ha * D)));
        "end" == this.pointPosition &&
          ((ja += D / 2 + Math.floor((Ha * D) / 2)),
          (ka = Math.floor(D) + Math.floor(Ha * D)),
          (ua = 0));
        if (vb) {
        ...
        n
          ? ((F = E),
            (Q = O),
            (O = E = ja),
            isNaN(la) && !this.fillToGraph && (Q = Fa),
            (Oa = Ba),
            (Pa = Ca))
          : ((Q = F = ja), isNaN(la) && !this.fillToGraph && (O = Fa));
        R < la &&
          ((x.isNegative = !0),
          Ka && (za = Ka),
          Ma && (Qa = Ma),
        ...
        switch (g) {
          case "line":
            isNaN(R)
              ...
              : ((x.isNegative = R < ea ? !0 : !1),
                ...
                (pa = F),
                (qa = E),
                !Na || isNaN(O) || isNaN(Q) || (T.push(Q), U.push(O)),
                (void 0 == x.lineColor &&
                  void 0 == x.fillColors &&
                  isNaN(x.dashLength)) ||
                  (this.drawLineGraph(q, t, T, U),
          ...
          case "smoothedLine":
            isNaN(R)
              ? u ||
                (this.drawSmoothedGraph(q, t, T, U),
                (q = []),
                (t = []),
                (T = []),
                (U = []))
                ...
                n
                  ? (isNaN(v) || (q.push(v), t.push(E - ka)),
                    ...
                    !Na ||
                      ...
                      U.push(O + ua)))
                  : (isNaN(s) ||
                      (t.push(s), q.push(v), t.push(s), q.push(F - ka)),
                    q.push(F - ka),
                    t.push(E),
                    q.push(F + ua),
                    t.push(E),
          ...
          case "column":
            ...
            if (!isNaN(R)) {
              ...
              var xb = f.min,
                yb = f.max;
              if (!((R < xb && la < xb) || (R > yb && la > yb)))
                if (n) {
                  "3d" == I
                    ? ((N = E - 0.5 * (h + G) + G / 2 + J * $), (M = Q + z * $))
                    : ((N = Math.floor(E - (p / 2 - $) * (h + G) + G / 2)),
                      (M = Q));
                  K = h;
                  ca = F;
                  ga = N + h / 2;
              ...
              if (
                ...
                "3d" == I &&
                  (n
                    ? ((y = (C - c) * (this.end + 1 - H)),
                      (ca += z * this.columnIndex),
                      (pa += z * this.columnIndex),
                      (x.y += z * this.columnIndex))
                    : ((y = (C - c) * (H + 1)),
                      (ca += 3),
                      (ga += J * this.columnIndex + 7),
                      (qa += J * this.columnIndex),
                      (x.y += J * this.columnIndex)));
                if ("regular" == I || "100%" == I)
                  "inside" != B && (B = "middle"),
                    (y = n
                      ? 0 < ta.value
              ...
              if (n) {
                if (
                  ...
                  !isNaN(Pa) &&
                    ...
                    E < l &&
                    0 < E &&
                    (($a = AmCharts.line(e, jb, [E, E], ma, V, L)),
                    (ib = AmCharts.line(e, kb, [E, E], ma, V, L)));
                  ba = F - Q;
                  na = new AmCharts.Cuboid(
                    e,
                    ba,
                ...
                !isNaN(Ca) &&
                  ...
                  F < k &&
                  0 < F &&
                  (($a = AmCharts.line(e, [F, F], lb, ma, V, L)),
                  (ib = AmCharts.line(e, [F, F], mb, ma, V, L)));
              }
              na &&
                ((sa = na.set),
                W.push(sa),
                sa.translate(M, N - L / 2),
                (x.url || this.showHandOnHover) &&
                  sa.setAttr("cursor", "pointer"),
                $a && (W.push($a), W.push(ib)),
                (ca = F),
                (ga = E),
                (pa = F),
                (qa = E),
          ...
          case "ohlc":
            if (!(isNaN(la) || isNaN(fb) || isNaN(gb) || isNaN(R))) {
              ...
              if (n) {
                ...
                0 < E &&
                  E < l &&
                  (nb = AmCharts.line(e, [Oa, Pa], [E, E], ra, V, L, Y));
                ...
                0 < F &&
                  F < k &&
                  (nb = AmCharts.line(e, [F, F], [Ba, Ca], ra, V, L, Y));
          ...
          if (this.end - this.start <= Bb || 0 === Bb) {
              ...
              switch (B) {
                ...
                case "bottom":
                  n && "column" == g
                    ? ((ca = Fa),
                      0 > R || (0 < R && f.reversed)
                        ? ((va = -6), fa.attr({ "text-anchor": "end" }))
                        : ((va = 6), fa.attr({ "text-anchor": "start" })))
                    : ((wa = Da / 2 + Ea / 2), (fa.x = -(Ia / 2 + 2)));
                  break;
                case "middle":
                  "column" == g &&
                    (n
                      ? ((wa = -(Ea / 2) + this.fontSize / 2),
                        (va = -(F - Q) / 2 - z),
                        0 > ba && (va += z),
                        Math.abs(F - Q) < Ia &&
            ...
            if ("regular" == I || "100%" == I) {
              ...
              if (Fb) {
                ...
                n
                  ? ((Ta = E),
                    (Sa = 0 > R ? F - Hb / 2 - 2 - Ua : F + Hb / 2 + 3 + Ua))
                  : ((Sa = F),
                    (Ta = 0 > R ? E + Ib / 2 + Ua : E - Ib / 2 - 3 - Ua));
                Ja.translate(Sa, Ta);
                f.totals[H] = Ja;
                n
                  ? (0 > Ta || Ta > l) && Ja.remove()
  ...
  drawLineGraph: function (a, b, c, d) {
    ...
    if (1 < a.length) {
      ...
      void 0 !== u &&
        ((m = AmCharts.line(g, a, b, u, p, m, q, !1, !0)), k.push(m));
      if (0 < f || 0 < v)
        if (
          ((m = a.join(";").split(";")),
          (p = b.join(";").split(";")),
          "serial" == e.chart.type &&
            (0 < c.length
              ? (c.reverse(), d.reverse(), (m = a.concat(c)), (p = b.concat(d)))
              : e.rotate
              ? (p.push(p[p.length - 1]),
                m.push(s),
                p.push(p[0]),
          ...
          0 < f &&
            ((b = AmCharts.polygon(g, m, p, r, f, 1, "#000", 0, a)),
            b.pattern(e.pattern),
            h.push(b)),
          t || void 0 !== u)
        )
  ...
  drawSmoothedGraph: function (a, b, c, d) {
    if (1 < a.length) {
      ...
      g.push(k.path);
      void 0 !== r &&
        ((l = new AmCharts.Bezier(f, a, b, r, v, l, p, 0, e)), h.push(l.path));
      0 < m &&
        ((k = a.join(";").split(";")),
        (n = b.join(";").split(";")),
        (l = ""),
        ...
        (q || (q = m),
        u || (u = r),
        (a = new AmCharts.Bezier(f, a, b, NaN, 0, 0, u, q, e, l)),
  ...
  createBullet: function (a, b, c, d) {
    ...
    isNaN(this.maxValue) ||
      isNaN(g) ||
      (f = (g / this.maxValue) * this.maxBulletSize);
    var h = f;
    this.bulletAxis &&
      ((f = a.values.error),
      isNaN(f) || (g = f),
    ...
    a.isNegative &&
      ...
      (l = this.bulletColorNegative);
    void 0 !== a.color && (l = a.color);
    var m;
    "xy" == this.chart.type &&
      this.valueField &&
      ((m = this.pattern), a.pattern && (m = a.pattern));
    e = this.bullet;
    a.bullet && (e = a.bullet);
          ...
          "function" == typeof m
            ? ((k = new m()),
              ...
              a.bulletConfig &&
                ...
                (k.bulletConfig = a.bulletConfig)),
              k.write(d),
              (k = k.set))
            : (this.chart.path && (m = this.chart.path + m),
              (k = d.set()),
              (d = d.image(m, 0, 0, f, f)),
              k.push(d),
              this.centerCustomBullets && d.translate(-f / 2, -f / 2)));
    k &&
      ((a.url || this.showHandOnHover) && k.setAttr("cursor", "pointer"),
      "serial" == this.chart.type &&
        (0 > b - 0 ||
          b - 0 > this.width ||
          c < -f / 2 ||
        ...
        (k.remove(), (k = null)),
      k &&
        (this.bulletSet.push(k),
        k.translate(b, c),
        this.addListeners(k, a),
        this.allBullets.push(k)),
      (a.bx = b),
      (a.by = c));
    a.bulletGraphics = k;
    return f;
...
AmCharts.ChartCursor = AmCharts.Class({
  ...
  createCursor: function () {
    ...
    a
      ? (e && (g.pointerWidth = 0),
        "right" == d
          ? e
            ? g.setBounds(n, p + m, n + r + l, p + u + m)
            : g.setBounds(n + r + l + f, p + m, n + r + 1e3, p + u + m)
          : e
          ? g.setBounds(n, p, r + n, u + p)
          : g.setBounds(-1e3, -1e3, n - q - f, p + u + 15))
      : ((g.maxWidth = r),
        c.parseDates && ((q = 0), (g.pointerWidth = 0)),
        "top" == d
          ? e
            ? g.setBounds(n + l, p + m, r + l + n, u + p)
            : g.setBounds(n + l, -1e3, r + l + n, p + m - q - f)
          : e
          ? g.setBounds(n, p, r + n, u + p - q)
          : g.setBounds(n, p + u + q + f - 1, n + r, p + u + q + f));
    this.hideCursor();
  },
  ...
  detectMovement: function () {
    ...
    if (a.mouseIsOver) {
      var b = a.mouseX - this.x,
        c = a.mouseY - this.y;
      0 < b && b < this.width && 0 < c && c < this.height
        ? (this.drawing
  ...
  getMousePosition: function () {
    ...
    this.rotate
      ...
      : ((a = a.mouseX - this.x), 0 > a && (a = 0), a > b && (a = b));
    return a;
  },
  ...
  zoom: function (a, b, c, d) {
    ...
    g.parseDates && !g.equalSpacing
      ? ((a = d - c + g.minDuration()), (a = e ? h / a : f / a))
      : (a = e ? h / (b - a) : f / (b - a));
    this.stepWidth = a;
  ...
  updateCursor: function (a, b) {
    ...
    this.drawingNow &&
      ...
      (this.drawingLine = AmCharts.line(
        this.container,
        [this.x + this.drawStartX, this.x + d],
        [this.y + this.drawStartY, this.y + e],
        this.cursorColor,
        1,
        1
      )));
      ...
      if (p) {
        ...
        if (c.mouseIsOver || y || z || this.forceShow)
          if (((this.forceShow = !1), z)) {
            ...
            0 !== d &&
              ...
              f.parseDates && !f.equalSpacing
                ? (c + d > w && (d = w - c),
                  ...
                  (g.end = c + d),
                  this.fire(g.type, g))
                : B + d >= this.data.length ||
                  0 > k + d ||
                  ((g.start = k + d), (g.end = B + d), this.fire(g.type, g)));
          } else {
            ...
            0 < this.cursorAlpha &&
              ...
              0 < A && !this.zooming
                ? isNaN(this.previousX)
                  ? s.translate(w, t)
                  : (s.translate(this.previousX, this.previousY),
                    s.animate({ translate: w + "," + t }, A, "easeOutSine"))
                : s.translate(w, t),
              (this.previousX = w),
              (this.previousY = t),
              s.show());
            ...
            t = !0;
            y && (t = !1);
            this.categoryBalloonEnabled && t
              ? (u
                  ? (q &&
                      ("right" == C
                        ? v.setBounds(k, l + h, k + m + g, l + r + h)
                        : v.setBounds(k, l + h, k + m + g, l + r)),
                    "right" == C
                      ? q
                        ? v.setPosition(k + m + g, l + r + h)
                        : v.setPosition(k + m + g + I, l + r + h)
                      : q
                      ? v.setPosition(k, l + r)
                      : v.setPosition(k - I, l + r))
                  : "top" == C
                  ? q
                    ? v.setPosition(k + r + g, l + h)
                    : v.setPosition(k + r + g, l + h - I + 1)
                  : q
                  ? v.setPosition(k + r, l + n)
                  : v.setPosition(k + r, l + n + I - 1),
                (s = this.categoryBalloonFunction)
                  ? v.showBalloon(s(p.category))
                  : f.parseDates
                  ? ((f = AmCharts.formatDate(
                      p.category,
                      this.categoryBalloonDateFormat
                    )),
                    -1 != f.indexOf("fff") &&
                      (f = AmCharts.formatMilliseconds(f, p.category)),
                    v.showBalloon(f))
                  : v.showBalloon(AmCharts.fixNewLines(p.category)))
              : v.hide();
            ...
            if (a != this.previousIndex || B != this.previousMostCloseGraph)
              if (
                ...
                this.destroyValueBalloons(),
                (this.resizedBullets = []),
                J && this.valueBalloonsEnabled && t && c.balloon.enabled)
              ) {
                this.valueBalloons = h = [];
                for (w = 0; w < J.length; w++)
                  if (
                    ((f = J[w]),
                    (!this.oneBalloonOnly || f == B) &&
                      f.showBalloon &&
                      !f.hidden &&
                      f.balloonText &&
                      ("step" == f.type &&
                        "left" == f.stepDirection &&
                        (p = this.data[a + 1]),
                      p))
                  ) {
                    v = p.axes[f.valueAxis.id].graphs[f.id];
                    ...
                    if (
                      ...
                      for (r = a + 1; r < this.data.length; r++)
                        if ((q = this.data[r]))
                          if (
                            ((v = q.axes[f.valueAxis.id].graphs[f.id]),
                            (s = v.y),
                            !isNaN(s))
                          )
                            break;
                    if (!isNaN(s)) {
                      ...
                      t &&
                        (1 != this.graphBulletSize &&
                          ...
                          (t = v.bulletGraphics) &&
                          (t.getBBox(),
                          t.translate(v.bx, v.by, this.graphBulletSize),
                          this.resizedBullets.push(v)),
                        (t = f.valueBalloon),
                        (C = c.getBalloonColor(f, v)),
                        t.setBounds(k, l, k + m, l + n),
                        (t.pointerOrientation = "H"),
                        t.changeColor(C),
                        void 0 !== f.balloonAlpha &&
                          (t.fillAlpha = f.balloonAlpha),
                        void 0 !== f.balloonTextColor &&
                          (t.color = f.balloonTextColor),
                        t.setPosition(r + k, q + l),
                        (r = c.formatString(f.balloonText, v, !0)),
                        (q = f.balloonFunction) && (r = q(v, f).toString()),
                        "" !== r &&
                          (u
                            ? t.showBalloon(r)
                            : ((t.text = r), (t.show = !0))),
                        !u && t.set && t.set.hide(),
                        h.push({ yy: s, balloon: t }));
                    }
                  }
...
AmCharts.SimpleChartScrollbar = AmCharts.Class({
  ...
  hideDragIcons: function () {
    this.resizingLeft ||
      this.resizingRight ||
      this.dragging ||
      (this.hideResizeGrips && (this.iconLeft.hide(), this.iconRight.hide()),
      this.removeCursors());
  },
    ...
    if (this.skipEvent) this.skipEvent = !1;
      ...
      if (f.parseDates && !f.equalSpacing) {
        ...
        f.startOnAxis &&
          ...
          (e.end = this.end),
          f.parseDates &&
            (a[this.start] && (e.startDate = new Date(a[this.start].time)),
    ...
    if (!isNaN(a)) {
      ...
      if (this.show) {
        ...
        "H" != v
          ? ((A = a - y / 2),
            b < h + w + 10 && "down" != v
              ? ((J = !0), d && (b += z), (z = b + t), (this.deltaSignY = -1))
              : (d && (b -= z), (z = b - w - t), (this.deltaSignY = 1)))
          : (2 * t > w && (t = w / 2),
            (z = b - w / 2),
            a < g + (k - g) / 2
              ? ((A = a + t), (this.deltaSignX = -1))
              : ((A = a - y - t), (this.deltaSignX = 1)));
        z + w >= l && (z = l - w);
        z < h && (z = h);
        A < g && (A = g);
        A + y > k && (A = k - y);
        ...
        0 < s || 0 === t
          ? (0 < q &&
            ...
            this.showBullet &&
              ((Z = AmCharts.circle(e, B, r, this.fillAlpha)), f.push(Z)))
          : ((r = []),
            (s = []),
            "H" != v
              ? ((g = a - A),
              ...
              : ((r = b - z),
                ...
                (r =
                  a < g + (k - g) / 2
                    ? [0, 0, A < a ? 0 : a - A, 0, 0, y, y, 0]
                    : [y, y, A + y > a ? y : a - A, y, y, 0, 0, y])),
            0 < q &&
              ((a = AmCharts.polygon(e, r, s, n, 0, u, I, q)),
              a.translate(1, 1),
              f.push(a)),
            (n = AmCharts.polygon(
              e,
        ...
        0 < this.animationDuration &&
          ...
          f.animate({ translate: A - e + "," + z }, b, "easeOutSine"),
          m &&
...
AmCharts.AmCoordinateChart = AmCharts.Class({
  ...
  parseSerialData: function () {
    ...
    if (e) {
      var f = !1,
        ...
        k;
      h &&
        ((f = h.parseDates), (k = h.forceShowField), (g = h.categoryFunction));
      var l, m;
      f &&
        ...
        f &&
          ((b = h.categoryFunction
            ...
            ? "fff" == h.minPeriod
              ...
              : new Date(b)
            : r
            ? AmCharts.stringToDate(b, r)
            : new Date(b)),
          (b = AmCharts.resetDateToMin(b, l, m, h.firstDayOfWeek)),
          (u.category = b),
          (u.time = b.getTime()));
  ...
  processFields: function (a, b, c) {
    ...
    d =
      "lineColor color alpha fillColors description bullet customBullet bulletSize bulletConfig url labelColor dashLength pattern".split(
        " "
      );
    ...
    if (a) {
      ...
      "top" == a.position
        ? b
          ...
          : ((a.y = c - e + g - 1), (a.x = d + f))
        : b
        ? ((a.y = c + g), (a.x = d + this.plotAreaWidth + f))
        : ((a.y = c + this.plotAreaHeight), (a.x = this.marginLeftReal));
    }
  },
  showZB: function (a) {
    var b = this.zbSet;
...
AmCharts.TrendLine = AmCharts.Class({
  ...
  draw: function () {
    ...
    h &&
      (k &&
        (k instanceof Date ||
          (k = w ? AmCharts.stringToDate(k, w) : new Date(k)),
        (a.initialDate = k),
        (d = h.dateToCoordinate(k))),
      l && (d = h.categoryToCoordinate(l)),
      m &&
        (m instanceof Date ||
          (m = w ? AmCharts.stringToDate(m, w) : new Date(m)),
        (a.finalDate = m),
        (e = h.dateToCoordinate(m))),
      n && (e = h.categoryToCoordinate(n)));
    r &&
      !s &&
      (isNaN(u) || (d = r.getCoordinate(u)),
      isNaN(q) || (e = r.getCoordinate(q)));
    p &&
      !s &&
      (isNaN(t) || (f = p.getCoordinate(t)),
      isNaN(v) || (g = p.getCoordinate(v)));
    isNaN(d) ||
      isNaN(e) ||
      isNaN(f) ||
      isNaN(f) ||
...
AmCharts.handDrawnLine = function (a, b, c, d, e, f, g, h, k, l, m) {
  ...
  for (m = 1; m < b.length; m++)
    for (
      var p = [b[m - 1], b[m]],
        r = [c[m - 1], c[m]],
        r = AmCharts.makeHD(p, r, a.handDrawScatter),
        p = r[0],
        r = r[1],
        u = 1;
      u < p.length;
    ...
    (u
      ...
      : ((B =
        ...
        0 < h &&
          (B += " A" + h + "," + r + ",0," + J + ",0," + q + "," + (v + k))),
    (B += " Z"),
    (B = a.path(B, void 0, void 0, "1000,1000").attr(z)),
    d.push(B),
    (B = a
      .path(
        " M" +
...
AmCharts.VMLRenderer = AmCharts.Class({
  ...
  pattern: function (a, b) {
    ...
    8 === document.documentMode
      ? ((c.type = "tile"), (c.src = b.url))
      : (c.setAttribute("type", "tile"), c.setAttribute("src", b.url));
  },
  update: function () {},
});
...
AmCharts.AmLegend = AmCharts.Class({
  ...
  drawLegend: function () {
    ...
    "outside" == b
      ? ((c = f.offsetWidth),
        (e = f.offsetHeight),
        f.clientHeight && ((c = f.clientWidth), (e = f.clientHeight)))
      : ((f.style.width = c + "px"), (f.className = "amChartsLegend"));
    this.divWidth = c;
  ...
  arrangeEntries: function () {
    ...
    for (s = 0; s < t.length; s++) {
      ...
      var z;
      this.equalWidths
        ? (z = f + A * (p + m + this.markerLabelGap))
        : ((z = C), (C = C + v.width + f + m));
      z + v.width > n &&
        0 < s &&
        0 !== A &&
        (w++, (A = 0), (z = f), (C = z + v.width + f + m));
      y.translate(z, (r + l) * w);
      A++;
      !isNaN(k) && A >= k && ((A = 0), w++);
      u.push(y);
    ...
    k = v.height + 2 * l - 1;
    "left" == a || "right" == a
      ? ((h = v.width + 2 * f), (g.style.width = h + b + c + "px"))
      : (h = h - b - c - 1);
    c = AmCharts.polygon(
      this.container,
      [0, h, h, 0],
    ...
    if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a)
      "center" == this.align
        ? (b = f + (h - v.width) / 2)
        : "right" == this.align && (b = f + h - v.width);
    u.translate(b, l + 1);
  ...
  createEntry: function (a) {
    if (!1 !== a.visibleInLegend) {
      ...
      (f = this.switchType) &&
        "none" != f &&
        ("x" == f
          ? ((r = this.createX()), r.translate(l / 2, l / 2))
          : (r = this.createV()),
        (r.dItem = a),
        !0 !== a.hidden
          ? "x" == f
            ...
            : r.show()
          : "x" != f && r.hide(),
        this.switchable || r.hide(),
        this.addListeners(r, a),
        (a.legendSwitch = r),
        k.push(r));
      f = this.color;
      a.showBalloon &&
      ...
      g &&
        l <= r &&
        g.translate(p, l / 2 + this.ly - r / 2 + (r + 2 - l) / 2 - n);
      var u;
      d &&
        ((d = AmCharts.fixBrakes(d)),
        (a.legendTextReal = d),
        (u = AmCharts.text(this.container, d, f, b.fontFamily, r, "start")),
  ...
  clickMarker: function (a) {
    this.switchable
      ...
      : this.textClickEnabled && this.dispatch("clickMarker", a);
  },
