/** 335392514463553019 */ self.document = self;
self.window = self;
var ytcfg = {
  d: function () {
...
ytcfg.set({
  ...
  INNERTUBE_CLIENT_VERSION: "2.20231026.01.00",
  INNERTUBE_CONTEXT: {
    client: {
      hl: "en-GB",
      gl: "MY",
      clientName: "WEB",
      clientVersion: "2.20231026.01.00",
    },
  },
  INNERTUBE_CONTEXT_CLIENT_NAME: 1,
  INNERTUBE_CONTEXT_CLIENT_VERSION: "2.20231026.01.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
  var policy = self.trustedTypes.createPolicy("youtubeServiceWorkerPolicy", {
    createScriptURL: function (unused) {
      return "https://www.youtube.com/s/desktop/5a6ba9d1/jsbin/serviceworker-kevlar-appshell.vflset/serviceworker-kevlar-appshell.js";
    },
  });
  importScripts(policy.createScriptURL(""));
} else {
  importScripts(
    "https://www.youtube.com/s/desktop/5a6ba9d1/jsbin/serviceworker-kevlar-appshell.vflset/serviceworker-kevlar-appshell.js"
  );
}
